...
public class FuelPriceService {
  ...
  public FuelPrice getFuelPrice() {
    ...
    try {
      Document document =
          Jsoup.connect("https://www.cargopedia.ro/preturi-carburanti-europa").get();
      return getFuelPriceFromHtml(document);
  ...
  public FuelPrice getFuelPriceFromHtml(Document document) {
